        ...
        <div class="relative wrapper">
            <div class="flex justify-between">
                ...
                <div class="flex flex-col items-end justify-center py-8 sm:justify-start sm:items-center lg:items-end sm:flex-row lg:flex-col">
                    <button class="relative z-30 flex flex-col justify-between appearance-none sm:order-2 h-7 cursor lg:hidden">
                        <span class="block h-1 w-9 bg-red"></span>
                        <span class="block h-1 w-9 bg-red"></span>
                        <span class="block h-1 w-9 bg-red"></span>
                    </button>
                    ...
                    <?php wp_nav_menu([
                        'container' => 'nav',
                        'container_class' => 'absolute z-10 h-screen lg:h-auto inset-0 lg:static flex justify-end lg:block order-1 lg:order-2 w-full lg:mt-[30px] lg:translate-x-0',
